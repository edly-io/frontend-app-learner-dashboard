...
const messages = defineMessages({
  ...
  calendar: {
    ...
    description: 'Header link for switching to sessions page.',
  },
  adminConsole: {
    id: 'learnerVariantDashboard.adminConsole',
    defaultMessage: 'Admin Console',
    description: 'Header link for switching to admin console page.',
  },
  logoAltText: {
